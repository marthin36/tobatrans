...
font-size: 16px;"> <a href="../logout.php" class="btn btn-success square-btn-adjust">Logout</a> </div>
     ...
     <div class="container">	
		<div class="row">
			<div class="col-md-10">
				<h3>Daftar Tujuan Toba Wisata</h3>
				<a href="tambah_tujuan_toba_wisata.php"><button class="btn btn-default"><span class="glyphicon glyphicon-plus"></span>Tambah Tujuan</button></a><br><br>
				<br>
            ...
            <th>Opsi</th>
					...
					<tr>
						...
						<td><?=$items['tempat_wisata'];?></td>
						<td>Rp. <?=$items['harga'];?></td>
						<td>
						<a href="perbarui_tujuan_toba_wisata.php?id_tujuan=<?=$items['id_tujuan']?>"><button class="btn btn-warning"><span class="glyphicon glyphicon-wrench"></span></button></a>
						<a href="hapus_tujuan_toba_wisata.php?id_tujuan=<?=$items['id_tujuan']?>"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a>
						</td>
					</tr>
				<?php } ?>
				</table>
