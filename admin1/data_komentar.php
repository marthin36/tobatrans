			...
			<div class="col-md-12">
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td><a href="tanggapan.php?id_komentar=<?=$komentars['id_komentar']?>"><button class="btn btn-primary" style="margin-right;padding-left: 5px;">Tanggapi</button></span></button></a>     <a href="hapus_komentar.php?id_komentar=<?=$komentars['id_komentar']?>""><button class="btn btn-danger" >Hapus</span></button></a></td>
					</tr>
                <?php } ?>
				</table>
			</div>
