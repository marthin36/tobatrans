<?php require_once("../conn.php"); 
    ...
    $show = mysqli_query($conn, "SELECT * FROM tujuan WHERE id_tujuan='$id'");
...
font-size: 16px;"> <a href="../logout.php" class="btn btn-success square-btn-adjust">Logout</a> </div>
     ...
     <div class="container">	
		<div class="row">
			<div class="col-md-10">
				<h3>Perbarui Tujuan Toba Car</h3>

        <form action="perbarui_tujuan_process.php?id_tujuan=<?=$id?>" method = "post" enctype="multipart/form-data">

				<div class="col-sm-8">
          <label>Tujuan</label>
          <input class="form-control" type="text" name="tujuan" placeholder="<?=$tujuans['kecamatan']?>"><br>
          <label>Harga</label>
          <input class="form-control"  type="number" name="harga" placeholder="<?=$tujuans['harga']?>"><br>
